...
static const struct ili9881c_instr t101p136cq_2lane_init[] = {
	//ILI9881C PAGE3
	ILI9881C_SWITCH_PAGE_INSTR(3),
	//GIP_1
	ILI9881C_COMMAND_INSTR(0x01, 0x00), //added
...
static int ili9881c_prepare(struct drm_panel *panel)
{
	...
	dev_info(&ctx->dsi->dev, "ili9881c_init start\n");
	...
	dev_info(&ctx->dsi->dev, "ili9881c_init end\n");
...
static const struct drm_display_mode t101p136cq_default_mode = {
	.clock		= 71670,		//60Hz
...
static int ili9881c_dsi_probe(struct mipi_dsi_device *dsi)
{
	...
	//dsi->format = MIPI_DSI_FMT_RGB888; // ORIGINAL, NOT WORKING
	dsi->format = MIPI_DSI_FMT_RGB565; // MODDED FOR HMI-2002 on RPI CM5 (STORWAY) - USE WITH vc4-kms-dsi-rzw-t101p136cq-cm5-overlay 
